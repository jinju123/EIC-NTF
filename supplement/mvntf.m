function [t]=mvntf(X,R,L,A,B,C,options, rEndmember)
...
while 1
    ...
    oldSad=sad;
    oldRmse=rmse;  
    M=myKr(C,B,ones(1,R),ones(1,R)*L);%B@C
    ...
    [sad,allSadDistance,sor]=cosDistance(C,rEndmember);
